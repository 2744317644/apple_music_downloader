...
func GetAlbumResp(storefront string, id string, language string, token string, mediaUserToken string) (*AlbumResp, error) {
	var err error
	if token == "" {
		token, err = GetToken()
		if err != nil {
...
func GetAlbumRespByHref(href string, language string, token string, mediaUserToken string) (*AlbumResp, error) {
	var err error
	if token == "" {
		token, err = GetToken()
		if err != nil {
